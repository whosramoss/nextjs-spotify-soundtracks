export default class AppMetadata {
  ...
  constructor(isLocalTest: boolean) {
    ...
    this.META_URL = "https://github.com/whosramoss/nextjs-spotify-soundtracks/";
    this.META_NAME = "Nextjs Spotify Soundtracks";
    this.META_DESCRIPTION = "A curated collection of Spotify soundtracks";
